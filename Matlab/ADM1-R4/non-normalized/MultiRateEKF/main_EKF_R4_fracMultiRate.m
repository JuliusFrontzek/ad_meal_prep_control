...
% get measurements and unite them in one array containing NaNs when no 
% (offline) measurement was returned
MEASOn = MESS.yMeasOn;
...
%     [xPlus,PPlus,Kv] = constrainedExtendedKalmanFilter(xMinus,POld,tSpan,feedInfo,yMeas,AC,R); % constrained EKF
    [xPlus,PPlus] = extendedKalmanFilterMultiRate(xMinus,PMinus,feedInfo,yMeas,params,Q,R,f,g,dfdx,dhdx,tSpan,nStates,qOn,qOff,flagAugmented,flagMajor); % mulirate EKF
