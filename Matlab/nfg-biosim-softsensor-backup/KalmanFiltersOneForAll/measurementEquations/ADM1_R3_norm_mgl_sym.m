...
function gNorm = ADM1_R3_norm_mgl_sym(xNorm,c,Tx,Ty)
...
gNorm = [c(13)*Tx(16)^2/Ty(1)*xNorm(16)^2 + c(14)*Tx(16)*Tx(17)/Ty(1)*xNorm(16)*xNorm(17) + c(15)*Tx(17)^2/Ty(1)*xNorm(17)^2 + c(16)*Tx(16)/Ty(1)*xNorm(16) + c(17)*Tx(17)/Ty(1)*xNorm(17) + c(18)/Ty(1); % volFlow
