...
function gNorm = ADM1_R3_frac_norm_mgl_sym(xNorm,c,Tx,Ty)
...
gNorm = [c(13)*Tx(17)^2/Ty(1)*xNorm(17)^2 + c(14)*Tx(17)*Tx(18)/Ty(1)*xNorm(17)*xNorm(18) + c(15)*Tx(18)^2/Ty(1)*xNorm(18)^2 + c(16)*Tx(17)/Ty(1)*xNorm(17) + c(17)*Tx(18)/Ty(1)*xNorm(18) + c(18)/Ty(1); % volFlow
