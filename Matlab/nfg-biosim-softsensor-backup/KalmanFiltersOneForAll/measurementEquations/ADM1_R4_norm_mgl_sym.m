...
function gNorm = ADM1_R4_norm_mgl_sym(xNorm,c,Tx,Ty)
% delivers a symbolic expression (h) of normalized measurement equation of 
% the ADM1_R4

% measurement equations
gNorm = [(c(6)*Tx(10)^2*xNorm(10)^2 + c(7)*Tx(10)*Tx(11)*xNorm(10)*xNorm(11) + ...
    c(8)*Tx(11)^2*xNorm(11)^2 + c(9)*Tx(10)*xNorm(10) + ...
    c(10)*Tx(11)*xNorm(11) + c(11))/Ty(1); % volFlow [L/d]
