...
function gNorm = ADM1_R4_frac_norm_mgl_sym(xNorm,c,Tx,Ty)
% delivers a symbolic expression (h) of normalized measurement equation of 
% the ADM1_R4_frac

% measurement equations
gNorm = [(c(6)*Tx(11)^2*xNorm(11)^2 + c(7)*Tx(11)*Tx(12)*xNorm(11)*xNorm(12) + c(8)*Tx(12)^2*xNorm(12)^2 + c(9)*Tx(11)*xNorm(11) + c(10)*Tx(12)*xNorm(12) + c(11))/Ty(1); % volFlow [L/d]
