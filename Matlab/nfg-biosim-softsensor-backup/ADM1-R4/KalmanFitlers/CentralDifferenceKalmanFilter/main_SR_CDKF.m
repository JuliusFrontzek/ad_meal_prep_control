%% Square-Root Central Difference Kalman Filter nach van der Merwe 
% (Diss, 2004, S.118) fürs ADM1-R4
...
for k = 1:nMeas 
    ...
    [xPlus,PPlus,Kv] = sqrtCentralDiffKalmanFilter(xMinus,POld,tSpan,feedInfo,yMeas,AC);
