...
%% Unscented und Cubature Kalman Filter für ADM1-R4-bac-m3
% mit Konzentrationen in kg/m³ und Volumina in m³
% mit Messung von mikrobieller Biomasse
...
for k = 1:nSamples 
    ...
    % call EKF:
%     [xPlusEKF,PPlusEKF,~] = extendedKalmanFilterGasPhase(xMinusEKF,PMinusEKF, ...
%                         tSpan,feedInfo,yMeas,params,Q,R,f,g,dfdx,dhdx); % exclude pCO2 as measurement
    [xPlusEKF,PPlusEKF,~] = extendedKalmanFilter(xMinusEKF,PMinusEKF, ...
                        tSpan,feedInfo,yMeas,params,Q,R,f,g,dfdx,dhdx);
    
    % call UKF:
%     [xPlusUKF,PPlusUKF] = unscKalmanFilterKolasAdditiveGasPhase(xMinusUKF,PMinusUKF,...
%                             tSpan,feedInfo,yMeas,params,Q,R,f,g); % exclude pCO2 as measurement
