...
function [xPlusNorm,PPlusNorm] = unscKalmanFilterKolasAugmentedNorm(xOldNorm,POldNorm, ...
...
PyyNorm = Wc.*diffYFromSigmaOutputsNorm*diffYFromSigmaOutputsNorm' + RNorm; % Kolas, Tab. 6
...
sigmaXNorm = sigmaXPropNorm + KNorm*(repmat(yMeasNorm,1,nSigmaPointsAug) - YNorm);
