...
%% DAS Kalman Filter fürs ADM1-R4-noWaterAsh in normierten Koordinaten

addpath('generatedOutput/')
addpath('modelEquations/')

warning('off','optim:fmincon:SwitchingToMediumScale'); % suppress warnings of fmincon   
...
%                             tSpan,feedInfo,yMeas,params,Q,R,f,g);  
    ...
    % UKF-fully-aug:
%     [xPlus,PPlus] = unscKalmanFilterKolasFullyAugmented(xMinus,PMinus,...
%                             tSpan,feedInfo,yMeas,params,Q,R,f,g);  
...
%                         fNorm,gNorm,TxNum,TyNum,TuNum); 
    ...
    % cUKF-aug-norm:
%     [xPlusNorm,PPlusNorm] = constrUnscKalmanFilterKolasAugmentedNorm(xMinusNorm,PMinusNorm,...
%                         tSpan,feedInfoNorm,yMeas,params,QNorm,RNorm,...
%                         fNorm,gNorm,TxNum,TyNum,TuNum); 

    % cUKF-fully-aug-norm: 
%     [xPlusNorm,PPlusNorm] = constrUnscKalmanFilterKolasFullyAugmentedNorm(xMinusNorm,PMinusNorm,...
%                     tSpan,feedInfoNorm,yMeas,params,QNorm,RNorm,...
%                     fNorm,gNorm,TxNum,TyNum,TuNum); 
