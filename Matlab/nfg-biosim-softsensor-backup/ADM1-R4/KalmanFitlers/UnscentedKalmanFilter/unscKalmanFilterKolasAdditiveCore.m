...
function [xPlus,PPlus] = unscKalmanFilterKolasAdditiveCore(xOld,POld,...
...
PPlusTemp = PPlusKolasFullyAugmented + Q + K*R*K'; % different formula for additive noise case!
PPlusVachhaniTemp = PPlusKolasFullyAugmented;
