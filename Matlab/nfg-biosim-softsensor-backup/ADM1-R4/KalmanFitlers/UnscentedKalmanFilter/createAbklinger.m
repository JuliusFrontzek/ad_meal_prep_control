...
% std. deviations: 
sigmaV = 0.2/3600; % Trommelgaszähler [L/h], umgerechnet in [L/s]
sigmaCh4 = 0.002;   % [%]
sigmaCo2 = 0.002;   % [%]
sigmaSIN = 0.12;    % [g/L]
...
sigmas = [sigmaV, sigmaCh4, sigmaCo2, sigmaTS, sigmaTS, sigmaVS]; 
...
% SIN:  
subplot(2,2,4)
plot(tGrid,yClean(:,4),'r','LineWidth',2,'DisplayName','clean')
hold on
plot(tGrid, SINMeas, 'b-.','LineWidth',0.5,'DisplayName','noisy')
...
save('Messung_ADM1_R4_Abklinger.mat', 'MESS', 'pFix', 'params')
