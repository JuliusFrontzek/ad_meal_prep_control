...
load Messung_ADM1_R4_noWaterAsh_norm
...
xMinusCKFNorm = xHatNorm;      % to be overwritten
...
PMinusCKFNorm = P0Norm;  % to overwrite
...
dynamicsNorm = BMR4_AB_noWaterAsh_norm_ode_sym(xNormS, uNorm, xiNormS, thS, cS, aS, TxS, Tu); 
outputsNorm = BMR4_AB_noWaterAsh_norm_mgl_sym(xNormS, cS, TxS, TyS); 
...
plot(t,yUKFDeNorm(:,1)/24,'DisplayName','UKF estimate deNorm',...
     'LineStyle','-', 'Color', colorPaletteHex(3), 'LineWidth',0.8);  
plot(t,yCKFDeNorm(:,1)/24,'DisplayName','CKF estimate deNorm',...
     'LineStyle','-', 'Color', 'magenta', 'LineWidth',0.8);  
plot(t,UKFOutput(:,1)/24,'DisplayName','estimate abs',...
...
plot(t,yUKFDeNorm(:,2),'DisplayName','estimate deNorm',...
     'LineStyle','-', 'Color', colorPaletteHex(3), 'LineWidth',0.8);  
plot(t,yCKFDeNorm(:,2),'DisplayName','CKF estimate deNorm',...
     'LineStyle','-', 'Color', 'magenta', 'LineWidth',0.8);
plot(t,UKFOutput(:,2),'DisplayName','estimate abs',...
     'LineStyle','--', 'Color', colorPaletteHex(5), 'LineWidth',1.2); 
ylim([0.4,0.85])
ylabel('p_{ch4} [bar]')
yyaxis right
...
plot(t,yUKFDeNorm(:,3),'DisplayName','estimate deNorm',...
     'LineStyle','-', 'Color', colorPaletteHex(3), 'LineWidth',0.8);
plot(t,yCKFDeNorm(:,3),'DisplayName','CKF estimate deNorm',...
     'LineStyle','-', 'Color', 'magenta', 'LineWidth',0.8);
plot(t,UKFOutput(:,3),'DisplayName','estimate abs',...
     'LineStyle','--', 'Color', colorPaletteHex(5), 'LineWidth',1.2); 
ylim([0.2,0.6])
ylabel('p_{co2} [bar]')
xlabel('time [d]')
...
plot(t,yCKFDeNorm(:,4),'DisplayName','CKF estimate deNorm',...
     'LineStyle','-', 'Color', 'magenta', 'LineWidth',0.8);
plot(t,UKFOutput(:,4),'DisplayName','estimate abs',...
     'LineStyle','--', 'Color', colorPaletteHex(5), 'LineWidth',1.2); 
...
plot(tMeas,trueStates(:,4),'DisplayName','true',...
     'LineStyle','-.', 'Color', colorPaletteHex(2), 'LineWidth',1.5); 
hold on; 
plot(t,ESTIMATESUKF(:,4),'DisplayName','UKF estimate abs',...
     'LineStyle',':', 'Color', colorPaletteHex(4), 'LineWidth',1.2); 
plot(t,xUKFDeNorm(:,4),'DisplayName','estimate deNorm',...
     'LineStyle','-', 'Color', colorPaletteHex(3), 'LineWidth',0.8); 
plot(t,xCKFDeNorm(:,4),'DisplayName','CKF estimate deNorm',...
     'LineStyle','--', 'Color', 'magenta', 'LineWidth',0.6); 
% ylim([0.4,0.7])
ylabel('X_{ch} [g/L]')
yyaxis right
...
plot(tMeas,trueStates(:,7),'DisplayName','true',...
     'LineStyle','-.', 'Color', colorPaletteHex(2), 'LineWidth',1.5); 
hold on; 
plot(t,ESTIMATESUKF(:,7),'DisplayName','UKF estimate abs',...
     'LineStyle',':', 'Color', colorPaletteHex(4), 'LineWidth',1.2); 
plot(t,xUKFDeNorm(:,7),'DisplayName','estimate deNorm',...
     'LineStyle','-', 'Color', colorPaletteHex(3), 'LineWidth',0.8); 
plot(t,xCKFDeNorm(:,7),'DisplayName','CKF estimate deNorm',...
     'LineStyle','--', 'Color', 'magenta', 'LineWidth',0.6); 
% ylim([0.4,0.7])
ylabel('X_{bac} [g/L]')
yyaxis right
