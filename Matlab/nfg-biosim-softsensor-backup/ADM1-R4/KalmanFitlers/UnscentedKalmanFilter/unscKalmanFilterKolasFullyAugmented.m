...
function [xPlus,PPlus] = unscKalmanFilterKolasFullyAugmented(xOld,POld, ...
...
Pyy = Wc.*diffYFromSigmaOutputs*diffYFromSigmaOutputs'; % Kolas, Tab. 7/8
...
PPlus = 1/2*(PPlusGentschTemp + PPlusGentschTemp');   
