...
% setup: 2-fold augmentation, out-of-sequence measurements
...
delayMin = 0.2;     % [d]
delaySpread = 1.8;    % [d] (manually chosen) 
...
% SIN:  
subplot(3,2,4)
scatter(tOfflineSample,yMeasOff(:,1),'DisplayName','noisy sample',...
        'Marker','o', 'Color', colorPaletteHex(1), 'LineWidth',1.5); 
hold on; 
scatter(tOfflineArrival,yMeasOff(:,1),'DisplayName','noisy arrival',...
...
% TS:  
subplot(3,2,5)
scatter(tOfflineSample,yMeasOff(:,2),'DisplayName','noisy sample',...
        'Marker','o', 'Color', colorPaletteHex(1), 'LineWidth',1.5); 
hold on; 
scatter(tOfflineArrival,yMeasOff(:,2),'DisplayName','noisy arrival',...
        'Marker','x', 'Color', colorPaletteHex(1), 'LineWidth',1.5); 
% hold last measurement value till end of simulation:
...
% VS:  
subplot(3,2,6)
scatter(tOfflineSample,yMeasOff(:,3),'DisplayName','noisy sample',...
        'Marker','o', 'Color', colorPaletteHex(1), 'LineWidth',1.5); 
hold on; 
scatter(tOfflineArrival,yMeasOff(:,3),'DisplayName','noisy arrival',...
        'Marker','x', 'Color', colorPaletteHex(1), 'LineWidth',1.5); 
% hold last measurement value till end of simulation:
...
fileName = 'Messung_ADM1_R4_frac_norm_MultiRate_aug2_outOfSeq.mat'; 
