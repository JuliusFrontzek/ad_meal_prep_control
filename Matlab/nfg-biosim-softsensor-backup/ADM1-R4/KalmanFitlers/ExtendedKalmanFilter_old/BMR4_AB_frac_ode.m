function f = BMR4_AB_frac_ode(th,x,feedVector,AC)
% XY: definiere die Eingangs-Variablen eher so: (t,x,xi,u,a,c,t)
...
% values for u and xin 
    
    u = feedVector(1);      % feedVolumeFlow
    xi = feedVector(2:end); % inlet concentrations
    
    a = AC.a;   % stoichiometric constants from petersen matrix
    c = AC.c;   % time-invariant parameters
