%% Version
% (R2022b) Update 2
% Erstelldatum: 23.02.23
% Autor: Simon Hellmann

function [yCleanOn, yCleanOff] = computeSyntheticCleanMeasurements(MESS,p,pFix)
% 
...
% Fütterungen
% p - angepasste Modellparameter
% pFix - zeitinvariante Modellparameter
% C - Kovarianzmatrix des Messrauschens
...
%     x = x0;
    ...
    yCleanOn = yOnTemp(:,1:3); 
    yCleanOff = yOffTemp(:,4:6); 
