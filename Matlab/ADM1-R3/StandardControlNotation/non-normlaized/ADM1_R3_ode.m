%% Version
% (R2022b) Update 5
% Erstelldatum: 08.05.2023
% Autor: Simon Hellmann

function f = ADM1_R3_ode(x, u, xi, th, c, a)
% delivers a numeric expression (f) of the right-hand side of the 
% homogeneous ODE system of the ADM1-R3 (incl. balancing of ash) with 
% constant values for u and xin 

% ion balance: 
Phi = -x(12) + (x(4) - x(15))/17 - x(14)/44 - x(13)/60; % XY: Achtung: Definition von S_ion mit Sören klären!
...
f = [c(1)*(xi(1) - x(1))*u + a(1,1)*th(1)*x(6) + a(1,2)*th(2)*x(7) + a(1,3)*th(3)*x(8) - a(1,4)*th(5)*x(1)*x(10)/(th(6) + x(1))*Iac; 
     ...
     c(1)*(xi(3) - x(3))*u + a(3,1)*th(1)*x(6) + a(3,2)*th(2)*x(7) - a(3,3)*th(3)*x(8) - c(5)*(x(3) - x(14)) + c(7)*x(17) + a(3,4)*th(5)*x(1)*x(10)/(th(6) + x(1))*Iac;
     ...
     c(24)*x(17)^3 + c(23)*x(16)*x(17)^2 + c(22)*x(16)^2*x(17) + c(26)*x(17)^2 + c(25)*x(16)*x(17) + c(12)*(x(3) - x(14)) + c(28)*x(17)];    
end 
