...
function [xPlus,PPlus,Kv] = extendedKalmanFilter(xOld,POld,tSpan,feedInfo,yMeas,params,Q,R,f,g,dfdx,dhdx)
...
if isempty(tRelEvents)
    ...
    tEval = tSpan;
    odeFun = @(t,xP) dfP_dt(xP,feedVolFlow,xInCurr,params,Q,f,dfdx);    % XY Abhängigkeiten korrigieren!
