...
function dxdt = biomodell_1_zdgl(t,x,u,p)
...
tu = u(1,:);
q = u(2,find(t >= tu,1,'last'));    % zum aktuellen Zeitpunkt anliegender feed Volumenstrom
cSF = u(3,find(t >= tu,1,'last'));  % zum aktuellen Zeitpunkt anliegende Eingangskonzentration
