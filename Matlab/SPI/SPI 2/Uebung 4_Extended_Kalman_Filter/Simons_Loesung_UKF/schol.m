...
%
% Out:
%   L   - Upper triangular matrix such that A=L'*L if def>=0.
%   def - Value 1,0,-1 denoting that A was positive definite,
%         positive semidefinite or negative definite, respectively.
%
% Description:
%   Compute upper triangular Cholesky factor L of symmetric positive
...
function [L,def] = schol(A)
  ...
  L = L';   % turn into upper triangular matrix, so schol is consistent with chol from Matlab
