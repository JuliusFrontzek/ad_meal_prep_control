...
VP.CONS.ymax = [Inf;Inf];

% -- mit Parametersatz aus der PI

% Durchführung der OVP
% -- Aufruf siehe OVP.m
...
% Berechnung der Messwerte mit biomodell_messdaten.m
MESS(2) = biomodell_messdaten_real(MESS(2));
...
pOpt2 = fmincon(@guete_pi_WLS,pOpt1,[],[],[],[],pLB,pUB,[],[],MESS,invC)
