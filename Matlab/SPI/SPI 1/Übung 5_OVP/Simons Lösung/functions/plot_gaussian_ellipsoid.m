...
if ~exist('npts', 'var'), npts = []; end    % lasse npts leer, wenn Variable in Funktionsaufruf fehlt
if ~exist('axh', 'var'), axh = gca; end     % setze axh zu gca, wenn Variable in Funktionsaufruf fehlt
