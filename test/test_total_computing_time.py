...
my_scenario = '2a_robust_1sigma'  # '1b' '2a_robust', '2a_nominal', '2c', '2c_uninhibited', '2a_nominal_1sigma', '2a_robust_1sigma'
if my_scenario == '1b':
    scen_name = 'Scenario_1b_quadratic_robust_feedback_mismatch_1.5std_3tsap'
elif my_scenario == '2a_nominal':
    scen_name = 'Scenario_2a_dynamic_nominal_feedback_mismatch_2std_12tsap'
    ...
    scen_name = 'Scenario_2a_dynamic_robust_feedback_mismatch_2std_12tsap'
...
print(f"\ncomputation time was: {run_time_hh_mm_ss}, i.e., {run_time_sec} seconds.")