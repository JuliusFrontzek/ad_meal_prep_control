...
def simulator_plant_setup(
    ...
    simulator_plant = do_mpc.simulator.Simulator(model)
    ...
    simulator_plant.set_param(**params_simulator)

    tvp_template = simulator_plant.get_tvp_template()
    ...
    simulator_plant.set_tvp_fun(tvp_fun)

    p_num = simulator_plant.get_p_template()
    ...
    simulator_plant.set_p_fun(p_fun)

    simulator_plant.setup()

    return simulator_plant
