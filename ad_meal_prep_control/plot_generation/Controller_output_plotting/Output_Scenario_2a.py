...
def controller_plotting_2a(scenario_names=None):
    ...
    for scenario in scenario_names:
        ...
        if metadata['feedback']:
            ...
            try:
                ...
                if mpc['mpc'].meta_data['n_robust'] == 0:  # __SH nominal MPC
                    # fig.axes[1].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[0, :]*100, 'black',
                    #                 linestyle = 'dotted', label=r"$V_{CH_4,tank, MPC}$", linewidth=1)
                    # fig.axes[1].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[1, :]*100, 'blue',
                    #                 linestyle = 'dotted', label=r"$V_{CO_2,tank, MPC}$", linewidth=1)
                    fig.axes[2].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]),
                                     predicted_data[2, :],
                    ...
                    fig.axes[3].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]),
                                     predicted_data[3, :],
                    ...
                    fig.axes[4].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]),
                                     predicted_data[5, :], 'black',
                                     linestyle='dotted', label=r'$pH_{MPC}$', linewidth=1)
                    if 'nominal_feedback' in scenario:
                        fig.axes[4].set_ylim(bottom=4, top=None)  # ylim of pH
                        fig.axes[4].set_yticks(range(4, 15, 2))  # Set specific tick positions for pH

                if mpc['mpc'].meta_data['n_robust'] > 0:
                    # fig.axes[1].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[[0,1], :].transpose()*100, 'black',
                    #                 linestyle = 'dotted', label=r"$V_{CH_4,tank, MPC}$", linewidth=1)
                    # fig.axes[1].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[[2,3], :].transpose()*100, 'blue',
                    #                 linestyle = 'dotted', label=r"$V_{CO_2,tank, MPC}$", linewidth=1)
                    fig.axes[2].plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]),
                ...
                if 'nominal_feedback' in scenario:
                    ...
                    # axins_1.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[0, :]*100, 'black',
                    #                 linestyle = 'dotted', linewidth=1)
                    # axins_1.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[1, :]*100, 'blue',
                    #                 linestyle = 'dotted', linewidth=1)

                    # plot insets
                    axins_1 = fig.axes[2].inset_axes([0.1, 0.3, 0.3, 0.3], xlim=(0, 10), ylim=(0, 320))
                    axins_1.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]),
                                 predicted_data[2, :],
                    ...
                    axins_2.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]),
                                 predicted_data[2, :],
                    ...
                    # axins_2.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), mpc['mpc']['_aux', "v_gas_storage"],
                    #             'black', linewidth=1)
                    ...
                    # axins_3.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[3, :], 'rebeccapurple',
                    #                 linestyle = 'dotted', linewidth=1)
                    # axins_3.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[4, :], 'blue',
                    #                 linestyle = 'dotted', linewidth=1)
                if 'robust' in scenario:
                    pass
                    # axins_1.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[[0,1], :].transpose()*100, 'limegreen',
                    #                 linestyle = 'dotted', linewidth=1)
                    # axins_1.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[[2,3], :].transpose()*100, 'darkgreen',
                    #                 linestyle = 'dotted', linewidth=1)
                    # axins_2.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[[4,5], :].transpose(), 'rebeccapurple',
                    #                 linestyle = 'dotted', linewidth=1)
                    # axins_3.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[[6,7], :].transpose(), 'rebeccapurple',
                    #                 linestyle = 'dotted', linewidth=1)
                    # axins_3.plot(np.linspace(0, metadata['n_days_mpc'], num=predicted_data.shape[1]), predicted_data[[8,9], :].transpose(), 'blue',
                    #                 linestyle = 'dotted', linewidth=1)
        ...
        remove_duplicate_labels(fig, 2, legend_location='upper left')#, bbox_to_anchor=(0, 0.6))
